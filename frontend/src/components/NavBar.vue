...
<template>
  <nav class="bg-[#151e2b] text-white py-4 px-8 shadow-md flex justify-between items-center relative z-50">
    ...
    <div class="flex items-center gap-4">
      ...
      <div class="relative group py-2"> <div class="w-10 h-10 rounded-full bg-green-500 border-2 border-white flex items-center justify-center overflow-hidden cursor-pointer shadow-lg group-hover:ring-2 group-hover:ring-blue-400 transition">
        ...
        <div class="absolute right-0 top-full mt-1 w-48 bg-white text-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-right z-50 overflow-hidden border border-gray-100">
          ...
          <div @click="goToSettings" class="flex items-center gap-2 px-4 py-3 hover:bg-gray-100 cursor-pointer transition">
